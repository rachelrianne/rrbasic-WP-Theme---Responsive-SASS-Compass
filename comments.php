...
<?php if ( comments_open() ) : ?>
	...
	<div id="respond">
		...
		<h3 class="assistive-text"><?php comment_form_title( 'Leave a Reply', 'Leave a Reply to %s' ); ?></h3>
		...
		<?php else : ?>
			...
			<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
				...
				<p>
					<label for="comment" class="assistive-text">Comment:</label><br/>
